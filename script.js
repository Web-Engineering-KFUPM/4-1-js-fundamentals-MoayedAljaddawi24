...
// SCHOOL = "OtherCollege"; // const block cannot be reassigned
...
console.log(2 + "3")
console.log(2 + 3)
// when adding if one of the elemnts are string the other will be converted to a string and then concatenate them
...
console.log("var a = " + a)
// console.log("let b = " + b) // provide an error
